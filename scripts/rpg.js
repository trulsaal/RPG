...
const locations = [
  ...
  },
  {
    ...
    text: "The monster screams in pain. You gain XP and GOLD!",
  },
  {
    name: "lose",
...
function buyWeapon() {
  if (currentWeapon < weapons.length - 1) {
    if (gold >= 30) {
      ...
      goldText.innerText = gold;
      text.innerText = `You now have a new weapon! The ${newWeapon}.`;
...
function sellWeapon() {
  if (inventory.length > 1) {
    ...
    text.innerText =
      "Dont sell your only weapon! It will result in sertain death!";
  }
}
...
function defeatMonster() {
  text.innerText = "You slayed the monster!";
